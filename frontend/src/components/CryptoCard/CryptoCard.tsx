...
function CryptoCard ({image,quantity,name,onClick,metric}:Props) {
  return (
    <div>
  <div className="bg-gradient-to-br from-primary to-secondary  rounded-3xl border shadow-xl p-8 w-80 h-52">
