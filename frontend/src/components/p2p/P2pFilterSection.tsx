...
const filters = [
  ...
  },
  {
    ...
    options: [
      { value: 'Mercado Pago', label: 'Mercado Pago', checked: false },
  ...
  },
  {
    ...
    name: 'Ubication',
    options: [
      { value: 'Near my location', label: 'near my location', checked: false },
      { value: 'Colombia', label: 'Colombia', checked: false },
      { value: 'Bogota', label: 'Bogota', checked: false },
      { value: 'Cali', label: 'Cali', checked: false },
    ],
  },
]
...
export default function P2pFilterSection() {
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-center border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Peer To Peer Section</h1>
