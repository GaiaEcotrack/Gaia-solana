  ...
  return (
    <div className="col-span-full xl:col-span-8 bg-white  shadow-lg rounded-sm border border-slate-200 ">
      <header className="px-5 py-4 border-b border-slate-100 ">
        <h2 className="font-semibold text-slate-800 ">Market</h2>
      </header>
      <div className="p-3">
        {/* Table */}
        <div className="overflow-x-auto">
          <table className="table-auto w-full ">
            {/* Table header */}
            <thead className="text-xs uppercase text-slate-400  bg-slate-50  dark:bg-opacity-50 rounded-sm">
              <tr>
                <th className="p-2">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center gap-5">
                    ...
                    <div className="text-slate-800 ">Gaia</div>
                  </div>
                </td>
                <td className="p-2">
              ...
              <tr>
                <td className="p-2">
                  ...
                  <img src="/polkadot-new-dot-logo.svg" width="36" height="36" alt="" />
                    <div className="text-slate-800 ">Polkadot</div>
                  </div>
                </td>
                <td className="p-2">
              ...
              <tr>
                <td className="p-2">
                  ...
                  <img src="/VaraCrypto.png" width="36" height="36" alt="" />
                    <div className="text-slate-800 ">Vara</div>
                  </div>
                </td>
                <td className="p-2">
