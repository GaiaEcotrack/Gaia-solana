...
import Dashboard from './DashboardUser/DashboardOld';
...
import DashBoardGob from './DashBoardGob/DashBoardGob';
...
import UnderConstruction from './404/404page';
...
{ path: '/devices', Page: PanelUsuarioFinal },
{ path: '/profile', Page: UserRegister },
...
{ path: '/dashGovernament', Page: DashBoardGob },
{ path: '/blockchain', Page: Blockchain },
];
